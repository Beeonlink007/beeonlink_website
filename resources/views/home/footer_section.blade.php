            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <p>The innovative solutions tailored to meet diverse technological needs.
                             Their expertise spans web development, networking services, and
                             cutting-edge cyber security. Trust Beeonlink to elevate your digital presence with reliable and efficient solutions.</p>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <ul class="footer-quick-links">
                            ...
                            <li> <a href="/service">Networking Services</a></li>
                            <li> <a href="/contact">App Optimization</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6 col-sm-6">
